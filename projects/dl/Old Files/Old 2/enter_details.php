    ...
    <div id="content">
	  ...
	  <div id="contentmid">
		...
		<div id="search_form">
               ...
               <form method="post" name="search" id="search" action="process_enter_details.php" enctype="multipart/form-data">
			   
			        
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<label for="subject">Enter Your Name:</label>
                    <input type="text" name="name" placeholder="Enter Your Name" class="validate-subject required input_field" required>
                    <div class="cleaner h10"></div> 	<br/><br/>
					
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<label for="subject">Enter Your Email Id:</label>
                    <input type="email" name="email" placeholder="Enter Your Email Id" class="validate-subject required input_field" required>
                    <div class="cleaner h10"></div> 	<br/><br/>
					
					&nbsp;
					<label for="subject">Enter Your Mobile Number:</label>
                    <input type="text" name="mobno" placeholder="Enter Mobile Number" class="validate-subject required input_field" required>
                    <div class="cleaner h10"></div><br/><br/>
					
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<label for="subject">Enter Your Address:</label>
                    <textarea name="address" id="address" rows="2" cols="4" class="textarea" required></textarea>
                    <div class="cleaner h10"></div><br/><br/>
